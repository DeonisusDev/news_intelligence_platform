...
(rich event detail), and Phase 6.5 (user accounts). See `docs/adr/` and `docs/troubleshooting.md`
for the reasoning and real bugs hit along the way. Remaining phases (7-13) are sketched in the
plan's future-phases section - recommendations, data catalog, and beyond.
