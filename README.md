...
(rich event detail), Phase 6.5 (user accounts), and Phase 7 (recommendations). See `docs/adr/`
and `docs/troubleshooting.md` for the reasoning and real bugs hit along the way. Remaining phases
(8-13) are sketched in the plan's future-phases section - data catalog, operational maturity,
and beyond.
