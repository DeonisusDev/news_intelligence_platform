...
Phases 0-5 complete, plus a post-Phase-5 unit test suite, Phase 6 (web frontend), and Phase 6.1
(rich event detail). See `docs/adr/` and `docs/troubleshooting.md` for the reasoning and real
bugs hit along the way. Remaining phases (6.5, 7-13) are sketched in the plan's future-phases
section - user accounts, recommendations, and beyond.
